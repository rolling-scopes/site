...
export const reactEn: Trainer[] = [
  ...
  },
  {
    ...
    photo: andrejPodlubnyj,
  },
  {
    name: 'Valery Dluski',
    role: 'EPAM, Full Stack developer',
    bio: 'Valery is originally from Belarus and currently lives in Poland. Since childhood, he has been fascinated with technology, a passion that led him to spend seven years configuring security systems after university. Alongside his technical interests, he has always been passionate about football, enjoying it in every form, including playing, watching, or engaging in video games. However, his greatest passion is traveling, preferably backpacking and exploring new cultures and landscapes as much as possible.',
    photo: valeryDluski,
  },
  {
