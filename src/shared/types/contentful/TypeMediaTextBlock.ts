 ...
 * @version 41
 */
export type TypeMediaTextBlockSkeleton = EntrySkeletonType<TypeMediaTextBlockFields, 'mediaTextBlock'>;
/**
 ...
 * @version 41
 */
export type TypeMediaTextBlock<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypeMediaTextBlockSkeleton, Modifiers, Locales>;
export type TypeMediaTextBlockWithoutLinkResolutionResponse = TypeMediaTextBlock<'WITHOUT_LINK_RESOLUTION'>;
export type TypeMediaTextBlockWithoutUnresolvableLinksResponse = TypeMediaTextBlock<'WITHOUT_UNRESOLVABLE_LINKS'>;
export type TypeMediaTextBlockWithAllLocalesResponse<Locales extends LocaleCode = LocaleCode> = TypeMediaTextBlock<'WITH_ALL_LOCALES', Locales>;
export type TypeMediaTextBlockWithAllLocalesAndWithoutLinkResolutionResponse<Locales extends LocaleCode = LocaleCode> = TypeMediaTextBlock<'WITHOUT_LINK_RESOLUTION' | 'WITH_ALL_LOCALES', Locales>;
export type TypeMediaTextBlockWithAllLocalesAndWithoutUnresolvableLinksResponse<Locales extends LocaleCode = LocaleCode> = TypeMediaTextBlock<'WITHOUT_UNRESOLVABLE_LINKS' | 'WITH_ALL_LOCALES', Locales>;
