      ...
      <div className={cx('aws-badge', 'content', 'column-2')}>
        <article className={cx('aws-info')}>
          ...
          <Paragraph>
            ...
            your knowledge of AWS fundamentals to potential employers or clients.
          </Paragraph>
          <Paragraph>
            By the end of the course, you will have gained a solid foundation in AWS fundamentals
            and be prepared to pass the AWS Cloud Practitioner certification.
          </Paragraph>
        </article>
        <Image
