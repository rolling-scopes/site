    ...
    <section className={cx('aws-badge', 'container')} data-testid="aws-badge">
      <div className={cx('aws-badge', 'content', 'column-2')}>
        <article className={cx('aws-info')}>
          <SectionLabel>AWS DIGITAL BADGE</SectionLabel>
          <WidgetTitle mods="asterisk">AWS Cloud Practitioner</WidgetTitle>
          <Paragraph>
            Upon completing the course and passing the AWS Cloud Quest: Cloud Practitioner, you will
            obtain an AWS digital badge. This badge will recognize your achievement and demonstrate
            your knowledge of AWS fundamentals to potential employers or clients. By the end of the
            course, you will have gained a solid foundation in AWS fundamentals and be prepared to
