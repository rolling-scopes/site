...
export default async function DocPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (slug.length > 1) {
    fileUrl = `https://raw.githubusercontent.com/spanb4/docs/master/docs/${slug[0]}/${slug[1]}.md`;
  } else {
    fileUrl = `https://raw.githubusercontent.com/spanb4/docs/master/docs/${slug[0]}.md`;
  }
